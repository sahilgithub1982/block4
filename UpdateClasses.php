...
<section class="container my-2 bg-dark w-50 text-light p-2 studentsform">
 <form class="row g-3 p-3" action="UpdateClasses.php" method="POST">
 <div class="col-12">
         <label for="ClassesID" class="form-label">Class ID</label>
     ...
     <div class="col-12">
       ...
       <div class="col-12">
         ...
         <input type="text" class="form-control" name="ClassCapacity" >
       </div>
...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE Classes SET  Class_name = '$Cname', Capacity = '$Capacity' WHERE ClassesID = '$cID'";
