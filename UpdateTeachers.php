...
<section class="container my-2 bg-dark w-50 text-light p-2 studentsform">
 <form class="row g-3 p-3" action="UpdateTeachers.php" method="POST">
 <div class="col-12">
         <label for="TeachersID" class="form-label">Teacher ID</label>
         <input type="text" class="form-control" name="TeachersID">
       </div> 
     <div class="col-md-6">
...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE Teachers SET Teachers_fname = '$tFname', Teachers_lname = '$tLname', Teachers_salary = '$tsalary',  
    Teachers_phonenumber = '$tphone', Teachers_backgroundcheck = '$tback', Teachers_address = '$taddress' , ClassesID = 
    '$tClassID' WHERE TeacherID = '$tID' ";
