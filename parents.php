...
<section class="container my-2 bg-dark w-50 text-light p-2 studentsform">
 <form class="row g-3 p-3" action="parents.php" method="POST">
     <div class="col-md-6">
...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO Parents (parents_fname, parents_lname, parents_address,  parents_email, parents_phonenumber) 
    VALUES ('$pFname','$pLname','$paddress', '$pemail', '$pnumb')";
