...
?>
<center><h3>VIEW ALL PARENTS</h3></center>
<table>
    
    <tr>
        <th width="150px">Parents ID<br><hr></th>
        <th width="250px">PFName<br><hr></th>
        <th width="250px">PLName<br><hr></th>
...
<tr>
    <th>{$row['ParentsID']}</th>
    <th>{$row['parents_fname']}</th>
    <th>{$row['parents_lname']}</th>
    <th>{$row['parents_address']}</th>
    <th>{$row['parents_email']}</th>
    <th>{$row['parents_phonenumber']}</th>
