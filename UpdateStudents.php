...
<body>
  ...
  <section class="container my-2 bg-dark w-50 text-light p-2 studentsform">
    <form class="row g-3 p-3" action="UpdateStudents.php" method="POST">
      <div class="col-12">
        <label for="StudentsID" class="form-label">Students ID</label>
        <input type="text" class="form-control" name="StudentsID" >
      </div>
      <div class="col-6">
...
//connection will be checked here
if($link === false){
    die("Connection failed: ");
}

if(isset($_POST['submit'])){
    $sID = $_POST['StudentsID'];
    ...
    $sql = "UPDATE Students SET students_fname='$sFname', students_lname='$sLname', students_address='$saddress' , students_email = '$semail', ClassesID = '$sclassid', DinnerMoneyID = '$sdinnermoney'  WHERE StudentsID = '$sID' ";
