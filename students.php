...
<head>
  ...
  <style>
    body,
    html {
      background: url(img/student1.jpg);
...
<body>
  ...
  <section class="container my-2 bg-dark w-50 text-light p-2 studentsform">
    ...
    <div class="col-12">
        <label for="medicalinfo" class="form-label">medical Info</label>
        <input type="text" class="form-control" name="medicalinfo">
      </div>
        <div class="col-12">
...
if(isset($_POST['submit'])){
    ...
    $dob = $_POST['dob'];   
    $medical = $_POST['medicalinfo'];
    $sclassid = $_POST['StudentsClassID'];
    $sdinnermoney = $_POST['StudentsDinnerMoney'];
    


    $sql = "INSERT INTO students (students_fname, students_lname, students_address,dob,medical_info, ClassesID, DinnerMoneyID) VALUES ('$sFname','$sLname', '$saddress','$dob', '$medical', '$sclassid', '$sdinnermoney')";
